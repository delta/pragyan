...
<div id="loginbox" style="font-size:0.9em;position:absolute;left:575px;top:0px;color:#000;z-index:2;">&nbsp;&nbsp;<a id="loginToggle" href="#" style="text-decoration:none;color:#000;">Login</a>
<div id="login" style="font-size: 0.75em;margin-top:-15px;margin-left:0px;">
	<form method="post" name="user_toplogin_form" onsubmit="return checkTopForm(this)" action="./+login">
		<div>
			<fieldset>
			<legend style="padding-left:30px; padding-right:30px;" id="loginToggle2"><a href="#" style="text-decoration:none;color:#000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></legend>
				<table cellspacing="6">
					<tr>
						...
						<td><a style="cursor:pointer;color:#000;" onclick="window.location='./+login&subaction=register'"> Sign up </a></td>
					</tr>
					<tr>
