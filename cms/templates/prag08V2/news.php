...
function displayNews()
{
	...
	$news =<<<NEWS
		<style type="text/css">
		a.tickl{font-family:Verdana,Arial,Helvetica,sans-serif;font-size:11px;line-height:12px;text-decoration:none;color:#000;font-weight:bold;}
		.tickls{color:#666;}
		</style>
		<div id="newsbox" style="font-size:0.9em;position:absolute;right:45px;width:375px;top:80px;color:#000;z-index:2;">
		<div class="ticki" >
...
NEWS;
	...
	for ($i = 0; $i < sizeof($newsArray); $i++) {
		$newsFeed = $newsArray[$i]['title'];
		$newsFeed .= " - " . $newsArray[$i]['feed'];
		$newsLink = $newsArray[$i]['link'];
		//		displayerror()
