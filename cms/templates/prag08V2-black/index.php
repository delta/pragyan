...
<meta name="verify-v1" content="NyWjx2me0k7m/iO7NWSSWywrqzHJBJKX2uzUUQhVnAc=" >
...
<?
 ...
 ?>
  ...
  <script language="javascript" type="text/javascript" src="<?= $TEMPLATEBROWSERPATH ?>/../../modules/news/news.js"></script>
      ...
      <div id="header">
      	<span class="title_page">
			<a  href="<?= $urlRequestRoot?>">
				<img id="title_image" src="<?= $TEMPLATEBROWSERPATH?>/img/pragyan2.jpg" alt="Pragyan 08" border="0"/>
			</a>
		</span>
<?  require_once("$sourceFolder/$moduleFolder/news/news.php");
	echo displayNews();
	global $userId;
