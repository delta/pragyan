...
//TODO : make sure the data form is capable of file uplaod
...
//TODO : If the form is associated with a group, the form HAS to give the user the option to unregister from it.
	...
	function generateFormDescBody($moduleCompId, $action = 'editform') {
		...
		$imagePath = "$urlRequestRoot/$sourceFolder/$templateFolder";$calpath="$urlRequestRoot/$sourceFolder/$moduleFolder";
		...
		$formHeading = $headerText = $expiryDate = $requireLogin = $sendConfirmation = $useCaptcha = '';
		...
		<form id="formdetails" action="./+$action" method="post">
			<table width="70%" cellpadding="1" cellspacing="1" border="1">
				<tr>
					<td>Form Heading:</td><td><input type="text" name="txtFormHeading" value="$formHeading" /></td>
				</tr>
				<tr>
					<td>Require Login?</td>
					<td>
				...
				<tr>
					<td>Form Header:</td>
					<td>
						<textarea name="txtHeaderText" rows="5" cols="40">$headerText</textarea>
					</td>
				</tr>
				...
				<tr>
					<td>Form Footer:</td>
					<td>
						<textarea name="txtFooterText" rows="5" cols="40">$footerText</textarea>
					</td>
				</tr>
