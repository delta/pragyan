<?php
  ...
  ******************************************************************/
  ...
  class captcha
  {
    ...
    function captcha ($sourceFolder, $moduleFolder, $uploadFolder, $urlRequestRoot, $length = 5)
    {
...
//       die();
    ...
    function makeCaptcha ()
    {
      ...
      //$filter->blur($image, 6);
			...
			$this->captchaImageUrl = "$this->urlRequestRoot/$this->sourceFolder/$this->uploadFolder/temp/$captchaImageFile";
