...
WHERE d.page_modulecomponentid = $moduleComponentId AND d.user_id = $userId AND d.form_elementdata = \"$fileName\"";
	...
	public function deleteModule($moduleComponentId){
		$query = "DELETE FROM `form_desc` WHERE `form_elementdata`.`page_modulecomponentid` =$moduleComponentId";
		$result = mysql_query($query);
		$query = "DELETE FROM `form_desc` WHERE `form_regdata`.`page_modulecomponentid` =$moduleComponentId";
		$result = mysql_query($query);
		$query = "DELETE FROM `form_desc` WHERE `form_elementdesc`.`page_modulecomponentid` =$moduleComponentId";
		$result = mysql_query($query);
