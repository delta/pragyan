...
$css=$urlRequestRoot."/".$sourceFolder."/".$moduleFolder."/forum/images/styles.css";
$js=$urlRequestRoot."/".$sourceFolder."/".$moduleFolder."/forum/images/jscript.js";
$imgpath=$urlRequestRoot."/".$sourceFolder."/".$moduleFolder."/forum/";
$editor=<<<FORUM
...
<div id="bbeditor">
	...
	<td class="tbl1">
	<input name="sticky" value="1" type="checkbox"> Make this Thread Sticky(Moderators only can post stickies!)<br>
	</td>
	</tr>
