...
(23, 'hospi', 'view', 'view', 1, 'view the hospi'),
(24, 'hospi', 'accomodate', 'accomodate', 1, 'accomodate the hospi'),
(25, 'hospi', 'addroom', 'addroom', 1, 'addroom the hospi'),
(26, 'news', 'create', 'Create News', 20, 'Create a new News'),
(27, 'news', 'view', 'View', 0, 'VIew'),
(28, 'news', 'rssview', 'RSS View', 0, 'Retrieve News as RSS'),
(29, 'news', 'edit', 'Edit the news', 0, 'Edit the news item'),
(30, 'poll', 'create', 'Create Poll', 0, 'Create a Poll'),
(31, 'poll', 'view', 'Vote', 0, 'Vote for a poll'),
(32, 'pr', 'create', 'Create', 0, 'Create'),
(33, 'pr', 'view', 'View', 0, 'View'),
...
(41, 'qaos', 'qaosadmin', 'qaosadmin', 1, 'qaosadmin the qaos'),
